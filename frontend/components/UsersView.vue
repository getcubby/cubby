...
<template>
  <div class="user-table-container">
    <Dialog :title="`Edit user ${edit.user.username}`" ref="editDialog" reject-label="Cancel" reject-style="secondary" confirm-label="Save" confirm-style="success" @confirm="onEditSubmit">
