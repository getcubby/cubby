<template>
  <div class="user-table-container">
    ...
    <TableView style="max-height: 200px; width: 90%; max-width: 800px;" :columns="tableColumns" :model="tableModel">
      ...
      <template #action="slotProps"><Button text="Edit" small outline @click="onEdit(slotProps)" :disabled="slotProps.username === profile.username" style="float: right"/></template>
    </TableView>
